...
{
    public class SmartBoxesController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            return View(_context.smartBoxes.ToList());
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description,Image,DurataInNotti,Price")] SmartBox smartBox)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Description,Image,DurataInNotti,Price")] SmartBox smartBox)
        {
            if (id != smartBox.Id)
            {
                return NotFound();
